...
export const CITY_POIS = {
  ...
  nairobi: {
    name: 'Nairobi',
    groundElevation: 1660, // meters above WGS84 ellipsoid (CBD ~1,795 m MSL; geoid ~-15 m)
    viewBounds: {
      southwest: { lat: -1.45, lng: 36.65 },
      northeast: { lat: -1.15, lng: 37.05 },
    },
    pois: [
      {
        name: 'CBD / KICC',
  ...
  kenya: {
    ...
    groundElevation: 0,
    viewBounds: {
      southwest: { lat: -4.8, lng: 33.9 },
      northeast: { lat: 5.1, lng: 41.95 },
    },
    pois: [
      {
        name: 'Whole of Kenya',
