...
const LAYER_ALIASES = new Map([
  ...
  ['satellite rainfall', 'nasa-imerg-rain'],
  ['flood water', 'nasa-flood-water'],
  ['observed floods', 'nasa-flood-water'],
  ['satellite floods', 'nasa-flood-water'],
  ['gdacs', 'gdacs-flood-alerts'],
  ['flood alerts', 'gdacs-flood-alerts'],
  ['kmd', 'kmd-alerts'],
  ['kmd warnings', 'kmd-alerts'],
  ['met warnings', 'kmd-alerts'],
  ['weather warnings', 'kmd-alerts'],
  ['river sites', 'kenya-river-gauges'],
  ['flood footprints', 'kenya-flood-footprints'],
  ['footprints', 'kenya-flood-footprints'],
  ['inundation', 'kenya-flood-footprints'],
  ['3d floods', 'kenya-flood-footprints'],
