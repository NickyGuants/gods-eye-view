...
const PANEL_LABELS = {
  ...
  'kmd-alerts': 'KMD Warnings',
  'kenya-river-gauges': 'River Sites (GloFAS)',
  'kenya-flood-footprints': 'Flood Footprints (3D)',
  'kenya-county-rain': 'County Rainfall (7d)',
  'nasa-imerg-rain': 'Satellite Rainfall',
  'nasa-flood-water': 'Flood Water (observed)',
  'gdacs-flood-alerts': 'GDACS Flood Alerts',
